  ...
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const { isValid, errors } = allFieldsValidation(newCoupon, rules, {
        ...
        'numeric.percentage': 'Percentage must be a number.',
        'min.percentage': 'Percentage must be at least 1.',
        'max.percentage': 'Percentage cannot exceed 100.',
        'required.event': 'Event is required.',
        ...
        'numeric.userLimit': 'User limit must be a number.',
        'min.userLimit': 'User limit must be at least 1.'
      });
